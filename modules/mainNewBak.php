...
<tr><td bgcolor='#999999' class='style4'><table width='100%' border='0' align='center' cellpadding='0' cellspacing='1'>";
    ...
    <tr><td height='36' class='style18'>Promoter</td><td class='style18'>Artist</td><td class='style18'>Concert date1</td><td class='style18'>Id</td></tr>";
            $head1++;
        }
        if ($inquiry->status == 1) {
            if (!$head2)
...
function viewInquiry($id) {
    ...
    if ($id > 0) {
        ...
        $result.="</div></td>
              ...
              <tr>
                <td height='36' bgcolor='#FFFFFF' class='style17'><div align='left'>Concert date5</div></td>
...
$result.="
                  <tr>
                    ...
                    <td width='15%' height='35' align='center' class='style18'>Concert date6</td>
...
";
    ...
    $result.="</table></td></tr></table><input type='hidden' name='id' value='" . $busyday->contract_id . "'/>    
