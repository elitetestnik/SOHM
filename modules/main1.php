...
{  $vd = explode(" ",$inquiry->venue_date);
    ...
    if  ($inquiry->status==0){
    if(!$head1) $result.="<tr><td height='36' colspan='4' bgcolor='#FFFFFF'>&nbsp;&nbsp;<span class='style5'>Inquires</span>&nbsp;&nbsp;&nbsp;".$act_del."</td></tr>
    ...
    if  ($inquiry->status==1){
    if(!$head2) $result.="<tr><td height='36' colspan='4' bgcolor='#FFFFFF'>&nbsp;&nbsp;<span class='style5'>Inquires ()</span>&nbsp;&nbsp;&nbsp;".$act_del."</td></tr>
    <tr><td height='36' class='style18'>Promoter</td><td class='style18'>Artist</td><td class='style18'>Concert date</td><td class='style18'>Id</td></tr>";
    $head2++;
    }
    if  ($inquiry->status<0){
              ...
              <tr>
                <td bgcolor='#999999' class='style4'><table width='100%' border='0' align='center' cellpadding='3' cellspacing='1'>
                    ...
                    <tr>
                      ...
                      &nbsp;<a href='".$mosConfig_live_site."/modules/itn2.php?id=".$id_contract."' title='Print itinerary' target='_blank'  class='style17'>Print itinerary</a>
                      </div></td>
                    </tr>
                </table></td>
              </tr>
...
$mail = new PHPMailer(); // create a new object
  ...
  $mail->SMTPAuth = true; // authentication enabled
   $mail->From = "postmaster@back-track.no";
   $mail->Host = "smtp-event125.webhuset.no"; //mailout.one.com  send.one.com
   $mail->Port = 587;
   $mail->IsHTML(true);
   $mail->Username = "postmaster";//post@back-track.no stenolav post@stenolav-management.no
...
if ($busyday->freeday >0){$busyday->promoter_name="<B>ONE DAY OFF</B>";}
$result.="<tr>
