...
$cs=$pd=$pf=$p=$c=$pp=0;
$database->setQuery( "SELECT *, capacity as a_capacity,date_format(contract_date,'%d/%m/%Y') as c_date, date_format(concert_date,'%d/%m/%Y') as a_date FROM #__contracts  where id=".$date_d->contract_id );
