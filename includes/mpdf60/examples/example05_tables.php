...
<tr>
	...
	<td>111111111
	<img style="vertical-align: top" src="tiger.gif" width="80" />
	<img class="small my-foto cloudzoom" id="zoom1" src="'.$_SERVER['DOCUMENT_ROOT'].'/images/foto/700/1038341.jpg" >
	</td>

	<td style="background-gradient: linear #c7cdde #f0f2ff 0 1 0 0.5;">
	<p>This is data p</p>
	This is data out of p
	<p style="font-weight:bold; font-size:20pt; background-color:#FFBBFF;"><a href = "http://upgrade-up.ru/image.html?artikul=1038341">___Это что то ___</a></p>
	<b>11111111111112222222222222222333333333333333333ааааааааааааааааааааааа</b><br />
...
<tr>
	...
	<p>This is data p</p>
	This is data out of p
	<p style="font-weight:bold; font-size:20pt; background-color:#FFBBFF;">___Это что то ___</p>
	<b>11111111111112222222222222222333333333333333333ааааааааааааааааааааааа</b><br />
	This is normal data after br
	<h3>H3 in a table</h3>
	<div>This is data div</div>
