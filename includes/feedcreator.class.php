 ...
 * Version string.
 **/
define("FEEDCREATOR_VERSION", "FeedCreator 1.7.2 - Rewrited by Blagoslovenie.MSK.RU");
	...
	*/
	...
	function saveFeed($filename="", $displayContents=true) {
		...
		if ($feedFile) {
			...
			echo "<br /><b>Ошибка создания RSS-файла, проверьте доступность каталога на запись .</b><br />";
		}
	}
