   ...
   <tr>
        ...
        <tr>
          <td bgcolor="#999999" class="style4"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
              ...
              <tr>
                ...
                <td width="29%" bgcolor="#FFFFFF" class="style17">{COMPANY}{PRIORITY}</td>
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF" class="style17">{ADDR1}</td>
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF" class="style17 style34">{EMAIL}</td>
              ...
              <tr>
                ...
                &nbsp;<a href='#' onclick="javascript:add_our_comment2({ID});" class="style11">Add our comments</a>&nbsp;&nbsp;&nbsp;<a href='#' onclick='javascript:add_contract({ID},0);' class='style11'><img src="images/note-edit-24x24.png" align="absmiddle"></a>&nbsp;<a href='#' onclick='javascript:add_contract({ID},0);'  class='style11'>Add contract</a>&nbsp;&nbsp;&nbsp;<a href='#' onclick='javascript:editinquiryInfo(0,{ID});' class='style11'><img src="images/note-edit-24x24.png" align="absmiddle"></a>&nbsp;<a href='#' onclick='javascript:editinquiryInfo(0,{ID});'  class='style11'>Add inquiry</a>&nbsp;&nbsp;&nbsp;&nbsp;<span class='style11'><img src="images/doc.gif" width="20" height="20" align="absmiddle">Archive&nbsp;&nbsp;&nbsp;&nbsp;</span><a href='#' onclick="javascript:message_form(0,2,{ID});" ><img src="images/forward-new-mail-24x24.png" border=0 align="absmiddle"></a>&nbsp;<a href='#' onclick="javascript:message_form(0,2,{ID});" class="style11">Send message</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onclick="javascript:sms_form(0,2,{ID});" ><img src="images/forward-new-mail-24x24.png" border=0 align="absmiddle"></a>&nbsp;<a href='#' onclick="javascript:sms_form(0,2,{ID});" class='style11'>Send SMS</a></div></td>
              </tr>
          </table></td>
        </tr>
      </table>
      ...
      <hr>
      <input name="address" id="address" type="textbox" size="40" value="{COUNTRY} {LOCATION}"/>
