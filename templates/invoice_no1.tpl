          ...
          <table border="0" cellpadding="2" cellspacing="0">
            <tr>
              ...
              <td rowspan="2" valign='middle' align='center'>
                ...
                "font-size:12pt;margin:2px;line-height:100%;font-family:'Lucida Console';">{COMPANY_NAME}</h3><br />
                <span class='s8'>{S_WWW}</span>
              </td>
            ...
            <tr>
              <td align='center'>
                <p class='p1 s9'>{S_ADDRESS} <br>{S_ZIP_CODE}&nbsp;{S_CITY}<br>{S_COUNTRY}</p></TD></p></td>

              <td align='center'>
                <p class='p1 s9'>{S_PHONE}   <br> E-mail:{S_EMAIL}         <br>{S_ORG_NUMBER}</p></TD>
            </tr>
          </table>
        </td>
      </tr>
