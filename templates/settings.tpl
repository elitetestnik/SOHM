			 ...
			 <tr>
                    ...
                    <tr>
                        ...
                        <td height="36" bgcolor="#FFFFFF" class="style17">
                            ...
                            <INPUT TYPE="text" NAME="country" id='country' size='80' value="{COUNTRY}" ></td>
                    ...
                    <tr>
                        ...
                        <td height="36" bgcolor="#FFFFFF" class="style17">
                            ...
                            <INPUT TYPE="text" NAME="city" id='city' size='80' value="{CITY}" ></td>
                    ...
                    <tr>
                        ...
                        <td height="36" bgcolor="#FFFFFF" class="style17">
                            ...
                            <INPUT TYPE="text" NAME="address" id='address' size='80' value="{ADDRESS}" ></td>
                    ...
                    <tr>
                        ...
                        <td height="36" bgcolor="#FFFFFF" class="style17">
                            ...
                            <INPUT TYPE="text" NAME="zipcode" id='zipcode' size='80' value="{ZIP_CODE}" ></td>
                    ...
                    <tr>
                        ...
                        <td height="36" bgcolor="#FFFFFF" class="style17">
                            ...
                            <INPUT TYPE="text" NAME="phone" id='phone' size='80' value="{PHONE}" ></td>
                    ...
                    <tr>
                        ...
                        <td height="36" bgcolor="#FFFFFF" class="style17">
                            ...
                            <INPUT TYPE="text" NAME="org_number" id='org_number' size='80' value="{ORG_NUMBER}" ></td>
				...
				<INPUT TYPE="text" NAME="bankinfo" id='bankinfo' size='80' value="{BANKINFO}" ></td>
