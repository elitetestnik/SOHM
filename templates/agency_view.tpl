      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
          <td bgcolor="#999999" class="style4"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
              ...
              <tr>
                <td bgcolor="#FFFFFF" class="style17"><div align="left"><p>Agent</p></div></td>
             ...
             <tr>
                ...
                <a href='#' onclick="javascript:add_our_comment({ID},'agency');"><img src="images/comment-add-24x24.png"  align="absmiddle" border=0></a>
                &nbsp;<a href='#' onclick="javascript:add_our_comment({ID},'agency');" class="style11">Add our comments</a>&nbsp;&nbsp;&nbsp;<a href='#' onclick='javascript:message_form(0,4,{ID});'><img src="images/forward-new-mail-24x24.png" border=0 align="absmiddle"></a>&nbsp;<a href='#' class="style11" onclick='javascript:message_form(0,4,{ID});'>Send message</a><span class="style17">&nbsp;&nbsp;&nbsp;&nbsp;</span><a href='#' class="style11" onclick='javascript:sms_form(0,4,{ID});'><img src="images/right.gif" width="21" height="21" align="absmiddle"></a>&nbsp;<a href='#' class="style11" onclick='javascript:sms_form(0,4,{ID});'>Send SMS</a></div></td>
              </tr>
          </table></td>
        </tr>
      </table>
